...
class VoiceAssistant:
    ...
    def __init__(self, commands, language="pl", texts_file="texts.json", play_callback=None):
    ...
    def load_texts(self, path):
        try:
            ...
            print("Could not load texts.json:", e)
            return {}
    ...
    def record_audio(self, seconds=3, samplerate=16000):
        audio = sd.rec(int(seconds * samplerate), samplerate=samplerate, channels=1, dtype=np.int16, device=self.input_device)
        sd.wait()
